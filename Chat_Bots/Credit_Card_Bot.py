...
def test_credit_card_bot():
    ...
    queries = [
        #Your Query Goes here try -- "What is the outstanding amount for my HDFC card and also set a reminder for its payment by next Friday and also tell me my points.",
    ]
